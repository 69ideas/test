...
var _vueStrapMin = require('vue-strap/dist/vue-strap.min.js');

var _vueStrapMin2 = _interopRequireDefault(_vueStrapMin);
...
new _vue2.default({
    ...
    components: {
        'modal': _vueStrapMin2.default.modal
    },

    data: Object.assign(window.Bindings, vueData),

    methods: {
        showModal: function showModal(modelId) {
            if (typeof this.$data['modals'][modelId] == 'undefined') {
                this.$data['modals'][modelId] = true;
                this['modals'][modelId] = true;
            } else this['modals'][modelId] = !this['modals'][modelId];
        }
    }
});

},{"vue":3,"vue-strap/dist/vue-strap.min.js":2}]},{},[4]);

//# sourceMappingURL=vue-admin.js.map
